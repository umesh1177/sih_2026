      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full p-6 shadow-2xl border border-slate-200 my-8">
        ...
        <div className="flex border-b border-slate-200 my-4 text-xs font-semibold gap-2">
          <button
            ...
            className={`pb-2.5 px-4 border-b-2 font-bold transition-colors ${
          ...
          <button
            ...
            className={`pb-2.5 px-4 border-b-2 font-bold transition-colors flex items-center gap-1.5 ${
                        ...
                        <td className="py-3 px-4 text-center">
                          {isDisq ? (
                            <button
                              ...
                              className="px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-[11px] font-bold shadow-xs transition-all flex items-center gap-1 mx-auto"
