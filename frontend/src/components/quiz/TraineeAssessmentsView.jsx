                ...
                >
                  <div className="p-5 space-y-3">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex items-center gap-1.5 px-2.5 py-0.5 bg-amber-50 text-amber-800 border border-amber-200 rounded text-[11px] font-semibold shrink-0">
                    ...
                    <div className="bg-amber-50/60 border border-amber-200/60 rounded-xl p-2.5 space-y-1">
                      ...
                      <p className="text-[11px] text-amber-800 font-medium">
                        Instructor: <span className="font-semibold text-amber-950">{quiz.trainerName || "Faculty Lead"}</span>
                      </p>
                    </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead className="text-[11px] font-semibold uppercase text-slate-400 border-b border-slate-100">
                  <tr>
                    <th className="py-2.5 px-3">Quiz / Assessment</th>
                  ...
                  {filteredCompleted.map((row) => (
                    <tr key={row.id} className="hover:bg-slate-50/80 transition-colors group">
                      ...
                      <td className="py-3 px-3">
                        {row.isDisqualified ? (
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-semibold border bg-red-50 text-red-800 border-red-200">
                      ...
                      <td className="py-3 px-3 text-slate-700 font-mono font-medium whitespace-nowrap">
                        {row.timeTaken}
                      </td>
