...
export const CredentialsCertificationsView = ({ currentUser, onOpenCertificate, onOpenStudio }) => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8 max-w-7xl mx-auto font-sans text-slate-800 select-none">
      ...
      <div className="relative overflow-hidden bg-white rounded-3xl p-6 sm:p-8 text-slate-800 shadow-sm border border-slate-200 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 flex items-center gap-3.5 shrink-0 shadow-xs z-10">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl p-4 sm:p-5 border border-slate-200 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-slate-500">Distinction Honors (90%+)</p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <div className="py-16 px-4 bg-white rounded-3xl border border-slate-200 text-center space-y-3 shadow-sm">
          <div className="w-12 h-12 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center mx-auto">
            <FileQuestion className="w-6 h-6" />
          </div>
          <h3 className="font-bold text-slate-800 text-base">No Official Certificates Found</h3>
              ...
              >
                ...
                <div className="pt-5 mt-4 border-t border-slate-100 flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-extrabold rounded-xl text-xs shadow-sm transition-transform hover:scale-[1.02]"
                  >
