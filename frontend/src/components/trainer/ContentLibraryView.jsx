...
export const ContentLibraryView = ({ currentUser, onOpenStudio, initialSubjectFilter = "all" }) => {
    ...
    return [
      {
        ...
        render: (
          <div className="h-full flex flex-col justify-between p-6 sm:p-10 text-white bg-gradient-to-br from-[#071739] via-[#0a2558] to-[#12397e] rounded-2xl relative overflow-hidden">
            <div className="flex items-center justify-between border-b border-white/15 pb-4">
              ...
              <span className="px-3 py-1 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/30 text-[10px] font-bold">
                Official PPT Deck
              </span>
            </div>

            <div className="my-auto py-6 space-y-3 max-w-2xl">
              <span className="px-3 py-1 rounded-xl bg-blue-500/20 text-blue-200 border border-blue-400/30 text-xs font-bold inline-block">
                {subject}
              </span>
              ...
              <p className="text-xs sm:text-sm text-blue-100 font-medium leading-relaxed">
                Comprehensive training presentation covering: <b className="text-amber-300 font-bold">{topic}</b>
              </p>
            </div>
          ...
          <div className="h-full flex flex-col justify-between p-6 sm:p-10 text-slate-900 bg-white border border-slate-200 rounded-2xl">
            ...
            <div className="space-y-4 my-auto py-4">
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                ...
                <div className="p-3 bg-white rounded-xl border border-slate-200 font-mono text-xs sm:text-sm text-blue-900 font-bold overflow-x-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-700">
                <div className="p-3.5 bg-blue-50/60 rounded-xl border border-blue-100 space-y-1">
                  <h5 className="font-bold text-[#0a2558]">Hydrostatic Equation</h5>
                ...
                <div className="p-3.5 bg-indigo-50/60 rounded-xl border border-indigo-100 space-y-1">
                  <h5 className="font-bold text-indigo-900">Continuity Equation</h5>
          ...
          <div className="h-full flex flex-col justify-between p-6 sm:p-10 text-slate-900 bg-white border border-slate-200 rounded-2xl">
            ...
            <div className="space-y-4 my-auto py-4 text-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 space-y-1 ring-2 ring-emerald-400/40">
              ...
              <div className="p-3.5 bg-slate-900 text-white rounded-xl font-mono text-xs space-y-1">
                <div className="text-amber-300 font-bold">Courant-Friedrichs-Lewy (CFL) Constraint:</div>
            ...
            <div className="space-y-4 my-auto py-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-purple-50/70 rounded-2xl border border-purple-200 space-y-2">
                  <h5 className="font-bold text-purple-900">PBL Turbulence Closures</h5>
                ...
                <div className="p-4 bg-blue-50/70 rounded-2xl border border-blue-200 space-y-2">
                  <h5 className="font-bold text-blue-900">Cloud Microphysics Parameterization</h5>
                  <ul className="list-disc list-inside space-y-1 text-[11px] text-slate-700">
          ...
          <div className="h-full flex flex-col justify-between p-6 sm:p-10 text-slate-900 bg-gradient-to-br from-slate-50 to-blue-50/50 border border-slate-200 rounded-2xl">
            ...
            <div className="space-y-3.5 my-auto py-4 text-xs">
              <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm space-y-2">
                <h5 className="font-bold text-[#0a2558] text-sm">Key Operational Competencies Acquired:</h5>
                <div className="space-y-1.5 text-[11px] text-slate-700">
                  <p>✅ <b>Equation Selection:</b> Formulating non-hydrostatic primitives for deep tropical convection.</p>
                  <p>✅ <b>Grid Resolution:</b> Staggering variables on Arakawa-C mesh to prevent unphysical gravity oscillations.</p>
                  <p>✅ <b>Time Stepping:</b> Enforcing CFL Δt ≤ 6 × Δx for run convergence.</p>
                  <p>✅ <b>Forecast Verification:</b> Computing ETS, POD, and FAR against radar reflectivity and automatic weather station networks.</p>
                </div>
              </div>
    ...
    return [
      {
        ...
        render: (
          <div className="bg-white p-8 sm:p-12 shadow-sm rounded-xl border border-slate-200 space-y-6 text-slate-800 text-xs min-h-[580px] font-sans">
            {/* Header */}
            <div className="flex items-center justify-between border-b-2 border-[#0a2558] pb-4">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-[#0a2558] text-white font-black flex items-center justify-center text-base">
                  IMD
                </div>
                <div>
            ...
            <div className="space-y-2 pt-2">
              <span className="px-3 py-1 bg-blue-50 text-[#0a2558] font-bold text-xs rounded-lg border border-blue-200 inline-block">
                Subject: {subject}
              </span>
            ...
            {/* Abstract */}
            <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-1.5 leading-relaxed">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-slate-100 text-[11px]">
              <div>
                <p className="text-slate-400 font-bold">Author</p>
                <p className="font-extrabold text-slate-800">{author}</p>
              </div>
              <div>
                <p className="text-slate-400 font-bold">Document Format</p>
                <p className="font-extrabold text-slate-800">{item.format || "PDF Guide"}</p>
              </div>
              <div>
                <p className="text-slate-400 font-bold">File Size</p>
                <p className="font-extrabold text-slate-800">{item.size || "3.4 MB"}</p>
              </div>
              <div>
                <p className="text-slate-400 font-bold">Publication Date</p>
        ...
        render: (
          <div className="bg-white p-8 sm:p-12 shadow-sm rounded-xl border border-slate-200 space-y-6 text-slate-800 text-xs min-h-[580px] font-sans">
            ...
            <div className="space-y-4 leading-relaxed text-[11px] text-slate-700">
              ...
              <div className="p-3.5 bg-slate-900 text-emerald-300 font-mono rounded-xl text-xs overflow-x-auto shadow-inner">
        ...
        render: (
          <div className="bg-white p-8 sm:p-12 shadow-sm rounded-xl border border-slate-200 space-y-6 text-slate-800 text-xs min-h-[580px] font-sans">
            ...
            <div className="space-y-4 leading-relaxed text-[11px] text-slate-700">
              ...
              <div className="p-3 bg-blue-50 border border-blue-200 rounded-xl text-[11px] text-blue-950 font-medium">
            ...
            <div className="space-y-4 leading-relaxed text-[11px] text-slate-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                  <h5 className="font-bold text-slate-900">Root Mean Square Error (RMSE)</h5>
                  <p className="font-mono text-xs font-bold text-[#0a2558]">RMSE = √[ (1/N) Σ (F_i - O_i)² ]</p>
                </div>
                <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                  <h5 className="font-bold text-slate-900">Equitable Threat Score (ETS)</h5>
                  <p className="font-mono text-xs font-bold text-[#0a2558]">ETS = (Hits - Hits_random) / (Hits + FalseAlarms + Misses - Hits_random)</p>
                </div>
              </div>
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-7xl mx-auto font-sans text-slate-800 select-none">
      ...
      <div className="bg-gradient-to-r from-[#071739] via-[#0a2558] to-[#12397e] rounded-3xl p-6 sm:p-8 text-white shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-5 relative overflow-hidden">
        <div className="absolute right-0 top-0 opacity-10 pointer-events-none">
          <FolderKanban className="w-80 h-80 text-white" />
        </div>

        <div className="flex items-center gap-4 relative z-10">
          <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-tr from-amber-400 via-blue-200 to-white text-[#0a2558] flex items-center justify-center font-black text-2xl sm:text-3xl shadow-xl ring-2 ring-white/30 shrink-0">
        ...
        <div className="flex flex-wrap items-center gap-2.5 relative z-10">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-900 font-black rounded-2xl text-xs shadow-lg transition-all transform hover:scale-105"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-bold rounded-2xl text-xs transition-colors backdrop-blur-md"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Video Lectures</p>
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">PowerPoint PPTs</p>
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-sm flex items-center justify-between">
          <div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">PDF Handbooks</p>
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-sm flex items-center justify-between col-span-2 sm:col-span-1">
          <div>
            <p className="text-[11px] font-bold text-slate-400 uppercase tracking-wider">Lab Manuals</p>
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-2xl border border-slate-200 bg-slate-50/70 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0a2558]/20 focus:border-[#0a2558] text-xs font-semibold placeholder:text-slate-400 transition-all"
            />
            {searchQuery && (
          ...
          <div className="flex items-center gap-2 shrink-0">
            {viewMode === "kanban" && (
              <div className="flex items-center bg-slate-100 p-1 rounded-2xl border border-slate-200 text-[11px] font-bold text-slate-600">
                <span className="px-2 text-slate-400 uppercase text-[10px]">Group by:</span>
                <button
                  onClick={() => setKanbanGrouping("type")}
                  className={`px-2.5 py-1 rounded-xl transition-all ${kanbanGrouping === "type" ? "bg-white text-[#0a2558] shadow-sm" : "hover:text-slate-900"}`}
                >
                  Media Format
                </button>
                <button
                  onClick={() => setKanbanGrouping("status")}
                  className={`px-2.5 py-1 rounded-xl transition-all ${kanbanGrouping === "status" ? "bg-white text-[#0a2558] shadow-sm" : "hover:text-slate-900"}`}
                >
                  Workflow Status
                </button>
              </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5 pt-2 border-t border-slate-100 text-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 font-bold focus:outline-none focus:ring-1 focus:ring-[#0a2558] text-xs cursor-pointer max-w-[280px] truncate"
            >
          ...
          <div className="flex items-center gap-1.5">
            <select
              ...
              className="px-3 py-1.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 font-bold focus:outline-none text-xs cursor-pointer"
            >
      ...
      {loading ? (
        <div className="bg-white rounded-3xl p-16 border border-slate-200 text-center space-y-4">
          ...
          <p className="text-sm font-bold text-slate-600">Loading Content Repository...</p>
        </div>
      ) : filteredItems.length === 0 ? (
        <div className="bg-white rounded-3xl p-16 border border-slate-200 text-center space-y-4">
          <FolderKanban className="w-12 h-12 text-slate-300 mx-auto" />
          <div>
            <h3 className="text-base font-bold text-slate-800">No Learning Materials Found</h3>
          ...
          <button
            onClick={() => setIsUploadModalOpen(true)}
            className="px-5 py-2.5 bg-[#0a2558] hover:bg-[#071739] text-white font-bold rounded-2xl text-xs shadow-md transition-transform hover:scale-105 inline-flex items-center gap-2"
          >
            <Plus className="w-4 h-4" />
            <span>Upload New Material</span>
          </button>
                    ...
                    <tr key={item.id} className="hover:bg-blue-50/40 transition-colors">
                      ...
                      <td className="p-4 pl-6">
                        <div className="flex items-start gap-3">
                          <div className={`p-2.5 rounded-xl border shrink-0 ${badge.badgeBg}`}>
                            <TypeIcon className="w-4 h-4" />
                          </div>
                          <div>
                            <p 
                              className="font-bold text-slate-900 hover:text-[#0a2558] cursor-pointer line-clamp-1 text-xs"
                      ...
                      {/* Author Stamp */}
                      <td className="p-4 text-slate-700 font-bold text-[11px] whitespace-nowrap">
                      ...
                      <td className="p-4 text-right pr-6 whitespace-nowrap">
                        <div className="flex items-center justify-end gap-1.5">
                          <button
                            onClick={() => handleOpenPreview(item)}
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-blue-50 hover:bg-[#0a2558] text-[#0a2558] hover:text-white font-bold border border-blue-200 transition-all shadow-sm"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-5">
          {(kanbanGrouping === "type" ? [
            ...
            return (
              <div key={col.id} className="bg-slate-50/80 rounded-3xl p-4 border border-slate-200/90 flex flex-col space-y-3.5 shadow-inner">
                {/* Column Header */}
                <div className="flex items-center justify-between pb-2 border-b border-slate-200/60">
                  <div className="flex items-center gap-2">
                    <span className={`p-1.5 rounded-xl border ${col.color}`}>
                ...
                <div className="space-y-3 flex-1 overflow-y-auto max-h-[620px] pr-0.5">
                  {colItems.map(item => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200 space-y-3 relative group"
                      >
                        {/* Top Info Header */}
                        <div className="flex items-start justify-between gap-2">
                          <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${badge.badgeBg}`}>
                            <TypeIcon className="w-3 h-3" />
                            <span>{badge.label}</span>
                          </span>

                          <span className={`px-2 py-0.5 rounded-md text-[9px] font-black border uppercase tracking-wider ${getStatusBadge(item.status)}`}>
                            {item.status}
                          </span>
                        </div>
                        ...
                        {/* Title & Description */}
                        <div>
                          <h4 className="font-bold text-xs text-slate-900 leading-snug line-clamp-2 hover:text-[#0a2558] cursor-pointer" onClick={() => handleOpenPreview(item)}>
                            {item.title}
                          </h4>
                          {item.description && (
                        ...
                        <div className="p-2.5 rounded-xl bg-slate-50 border border-slate-100 space-y-1.5 text-[10px]">
                          <div className="flex items-center gap-1.5 text-slate-800 font-bold truncate">
                            ...
                            <span className="truncate text-slate-900 font-bold">{subjectName}</span>
                          </div>
                        ...
                        <div className="pt-2 border-t border-slate-100 flex items-center justify-between gap-1.5">
                          <button
                            onClick={() => handleOpenPreview(item)}
                            className="flex-1 flex items-center justify-center gap-1 py-1.5 bg-slate-100 hover:bg-[#0a2558] text-slate-700 hover:text-white rounded-xl text-[10px] font-bold transition-all shadow-sm"
                          >
                          ...
                          <button
                            onClick={() => handleGenerateAiSummary(item)}
                            className="p-1.5 bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-200 rounded-xl text-[10px] font-bold transition-colors"
                          ...
                          <button
                            onClick={() => handleDeleteItem(item.id, item.title)}
                            className="p-1.5 bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 rounded-xl text-[10px] font-bold transition-colors"
          ...
          <div className="bg-white rounded-3xl max-w-5xl w-full border border-slate-200 shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
            ...
            <div className="bg-gradient-to-r from-[#071739] to-[#0a2558] p-5 sm:p-6 text-white flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold tracking-tight">Upload Learning Material to Library</h3>
            ...
            <div className="p-5 sm:p-6 overflow-y-auto flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 text-xs">
              ...
              <form onSubmit={handleUploadSubmit} className="lg:col-span-7 space-y-4">
                ...
                <div>
                  <label className="block font-bold text-slate-700 mb-1.5">Select Content Format *</label>
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`p-2.5 rounded-2xl border text-left flex flex-col items-start gap-1 transition-all ${
                            isSelected
                              ? "bg-blue-50/80 border-[#0a2558] text-[#0a2558] ring-2 ring-[#0a2558]/20 font-bold"
                              : "bg-slate-50 border-slate-200 text-slate-600 hover:bg-slate-100"
                          }`}
                        >
                          <TypeIcon className={`w-4 h-4 ${isSelected ? "text-[#0a2558]" : "text-slate-400"}`} />
                          <span className="font-bold text-xs mt-0.5">{type.label}</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#0a2558] text-xs font-bold"
                    >
                      {availableSubjects.map((s, idx) => (
                        <option key={idx} value={s}>
                          {s}
                    ...
                    {uploadFormData.subject === "custom" && (
                      <input
                        ...
                        className="w-full mt-2 px-3 py-1.5 rounded-xl border border-slate-200 text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#0a2558]"
                      />
                    )}
                  </div>

                  <div>
                    <label className="block font-bold text-slate-700 mb-1">Topic Covered *</label>
                    <input
                      type="text"
                      required
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {uploadFormData.type === "video" ? (
                    ...
                    <div>
                      <label className="block font-bold text-slate-700 mb-1">Pages / Slides</label>
                      <input
                        type="number"
                        placeholder="e.g. 36"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0a2558] text-xs font-semibold resize-none"
                  />
                </div>
                ...
                <div className="pt-2 flex items-center justify-end gap-2.5">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-[#0a2558] hover:bg-[#071739] text-white font-bold rounded-xl text-xs shadow-md transition-transform hover:scale-105 disabled:opacity-50"
                  >
              ...
              <div className="lg:col-span-5 flex flex-col space-y-3">
                ...
                <div className="p-4 bg-slate-50/80 rounded-2xl border border-slate-200/80 space-y-3 flex-1 flex flex-col justify-between">
                  <div className="space-y-3">
                    
                    {/* Live Badge & Status */}
                    <div className="flex items-center justify-between">
                      <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold border ${getTypeBadge(uploadFormData.type).badgeBg}`}>
                      ...
                      <span className={`px-2 py-0.5 rounded-md text-[9px] font-black border uppercase tracking-wider ${getStatusBadge(uploadFormData.status)}`}>
                    ...
                    {uploadFormData.type === "ppt" ? (
                      <div className="aspect-video bg-gradient-to-br from-slate-900 to-[#0a2558] rounded-xl p-3 text-white flex flex-col justify-between shadow-inner">
                        <div className="flex items-center justify-between text-[9px] text-slate-300">
                          <span className="font-bold text-amber-300">IMD PPT DECK</span>
                      ...
                      <div className="aspect-video bg-slate-950 rounded-xl flex items-center justify-center text-white relative shadow-inner">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50/60 rounded-2xl p-4 sm:p-5 border border-blue-200 space-y-2.5">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-blue-100 text-[#0a2558] font-bold rounded-xl text-xs border border-blue-200 shadow-sm transition-all"
                  >
                ...
                {aiSummaryResult ? (
                  <div className="text-xs text-slate-800 whitespace-pre-line bg-white/90 p-4 rounded-xl border border-blue-100 font-medium leading-relaxed shadow-xs">
                    {aiSummaryResult}
                  </div>
                ) : (
