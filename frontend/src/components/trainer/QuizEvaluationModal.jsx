      ...
      <div className="bg-white rounded-[var(--radius)] shadow-2xl border border-slate-200 w-full max-w-5xl max-h-[92vh] flex flex-col overflow-hidden text-slate-800 my-auto">
        ...
        <div className="p-6 overflow-y-auto space-y-4 flex-1 text-xs bg-slate-50/50">
          ...
          {loading ? (
            ...
            <div className="py-16 px-4 text-center bg-white rounded-[var(--radius)] border border-slate-200 shadow-sm space-y-3">
            ...
            <>
              ...
              <div className="space-y-4">
                {filteredSubmissions.map((sub) => (
                  <div
                    key={sub.id}
                    className="p-5 bg-white rounded-[var(--radius)] border border-slate-200 shadow-sm space-y-3 hover:border-blue-300 transition-all"
                  >
                    {(() => {
                      ...
                      return (
                        <>
                          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pb-3 border-b border-slate-100">
                            <div className="flex items-center gap-3">
                              <div className={`w-10 h-10 rounded-[var(--radius)] text-white flex items-center justify-center font-medium text-xs shrink-0 shadow-sm ${
                              ...
                              <div>
                                <div className="flex items-center gap-2">
                                  ...
                                  {sub.cadreId && (
                                    <span className="font-mono text-[10px] bg-slate-100 text-slate-700 px-2 py-0.5 rounded font-medium">
                                      {sub.cadreId}
                                    </span>
                                  )}
                                  {isDisq && (
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              {isDisq && (
                                <button
                                  ...
                                  className="px-3 py-1.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white font-medium rounded-[var(--radius)] text-xs shadow-xs transition-transform hover:scale-105 flex items-center gap-1"
                                >
                          ...
                          {Array.isArray(sub.difficultyHistory) && sub.difficultyHistory.length > 0 && (
                            <div className="p-3 bg-slate-50 border border-slate-200 rounded-[var(--radius)] space-y-1.5">
                              ...
                              <div className="flex flex-wrap items-center gap-1.5">
                                {sub.difficultyHistory.map((h, idx) => {
                                  ...
                                  return (
                                    <span
                                      key={idx}
                                      className={`px-2 py-0.5 rounded-[var(--radius)] border text-[10px] font-medium ${
                                        isHard
                          ...
                          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-1">
                            ...
                            <button
                              ...
                              className="px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-[var(--radius)] text-xs transition-colors shrink-0 flex items-center gap-1.5"
                            >
