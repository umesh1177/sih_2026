      ...
      <div className="bg-white rounded-[var(--radius)] p-6 sm:p-8 text-slate-800 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border border-slate-200/90 relative overflow-hidden">
        ...
        <div className="flex items-center gap-2.5 shrink-0 z-10">
          <select
            ...
            className="px-3.5 py-2.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-800 font-medium rounded-[var(--radius)] text-xs focus:outline-none"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-[#0a2558] hover:bg-[#071c42] text-white font-semibold rounded-[var(--radius)] text-xs shadow-md transition-all transform hover:scale-105"
          >
