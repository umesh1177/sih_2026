...
export const OfficerProfileView = ({ onOpenCertificate }) => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8 max-w-7xl mx-auto font-sans text-slate-800 select-none">
      ...
      <div className="bg-white rounded-xl p-6 sm:p-8 border border-slate-200 shadow-xs relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6">
          ...
          <div className="p-4 bg-slate-50/80 rounded-[var(--radius)] border border-slate-100">
            ...
            <p className="font-medium text-slate-800 text-xs mt-0.5 truncate">{form.email}</p>
          </div>
      ...
      {currentUser?.status === "rejected" && (
        <div className="bg-rose-50 border-2 border-rose-300 rounded-[var(--radius)] p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-5 animate-in fade-in">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-[var(--radius)] bg-rose-600 text-white flex items-center justify-center shrink-0 shadow-md">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-rose-900">MoES Central Administration Review</span>
              </div>
              <h3 className="text-base font-black text-slate-900">
                Officer Profile Registration Rejected by Administrator
              </h3>
              <div className="bg-white/90 p-3.5 rounded-[var(--radius)] border border-rose-200 text-xs text-rose-950 font-medium">
                <span className="font-medium text-rose-900 block mb-0.5">Admin Feedback & Required Corrections:</span>
          ...
          <button
            ...
            disabled={loading}
            className="w-full md:w-auto px-6 py-3.5 bg-rose-600 hover:bg-rose-700 text-white font-extrabold rounded-[var(--radius)] text-xs shadow-lg transition-transform hover:scale-105 shrink-0 flex items-center justify-center gap-2"
          >
      ...
      {currentUser?.status === "pending" && (
        <div className="bg-amber-50 border border-amber-300 rounded-[var(--radius)] p-5 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 animate-in fade-in">
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-[var(--radius)] bg-amber-500 text-white flex items-center justify-center shrink-0 shadow-sm">
          ...
          <button
            onClick={() => handleSaveProfile(true)}
            disabled={loading}
            className="px-4 py-2 bg-amber-200 hover:bg-amber-300 text-amber-950 font-medium rounded-[var(--radius)] text-xs transition-colors shrink-0 whitespace-nowrap"
          >
            Sync & Re-Verify
          </button>
        </div>
      ...
      <div className="bg-white rounded-[var(--radius)] p-6 sm:p-8 border border-slate-200 shadow-sm space-y-5">
        
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-[var(--radius)] bg-blue-50 text-blue-800 flex items-center justify-center font-medium shadow-sm">
        ...
        <div className="flex flex-wrap gap-2.5 pt-1">
          {form.skills.map((skill, idx) => (
            <span
              key={idx}
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-50/70 text-blue-950 rounded-[var(--radius)] text-xs font-medium border border-blue-200 shadow-sm group hover:border-blue-300 hover:bg-blue-100/80 transition-all"
            >
        ...
        <div className="flex items-center gap-2 pt-2 max-w-lg">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-slate-50 rounded-[var(--radius)] border border-slate-200 text-xs focus:bg-white focus:ring-2 focus:ring-blue-600 focus:outline-none font-medium"
          />
          <button
            type="button"
            onClick={handleAddSkill}
            className="px-5 py-2.5 bg-[#0a2558] hover:bg-[#071c42] text-white font-extrabold rounded-[var(--radius)] text-xs flex items-center gap-1.5 shadow-sm transition-transform hover:scale-105"
          >
      ...
      <div className="bg-white rounded-[var(--radius)] p-6 sm:p-8 border border-slate-200 shadow-sm space-y-5">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-[var(--radius)] bg-purple-50 text-purple-800 flex items-center justify-center font-medium shadow-sm">
        ...
        <div className="flex flex-wrap gap-2.5 pt-1">
          {form.qualifications.map((qual, idx) => (
            <span
              key={idx}
              className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50/70 text-purple-950 rounded-[var(--radius)] text-xs font-medium border border-purple-200 shadow-sm group hover:border-purple-300 hover:bg-purple-100/80 transition-all"
            >
        ...
        <div className="flex items-center gap-2 pt-2 max-w-lg">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-slate-50 rounded-[var(--radius)] border border-slate-200 text-xs focus:bg-white focus:ring-2 focus:ring-purple-600 focus:outline-none font-medium"
          />
          <button
            type="button"
      ...
      <div className="bg-white rounded-[var(--radius)] p-6 sm:p-8 border border-slate-200 shadow-sm space-y-5">
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-[var(--radius)] bg-amber-50 text-amber-800 flex items-center justify-center font-medium shadow-sm">
        ...
        <div className="flex flex-wrap gap-2.5 pt-1">
          {form.experience.map((exp, idx) => (
            <span
              key={idx}
              className="inline-flex items-center gap-2 px-4 py-2 bg-amber-50/70 text-amber-950 rounded-[var(--radius)] text-xs font-medium border border-amber-200 shadow-sm group hover:border-amber-300 hover:bg-amber-100/80 transition-all"
            >
        ...
        <div className="flex items-center gap-2 pt-2 max-w-lg">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-slate-50 rounded-[var(--radius)] border border-slate-200 text-xs focus:bg-white focus:ring-2 focus:ring-amber-600 focus:outline-none font-medium"
          />
          <button
            type="button"
      ...
      <div className="bg-white rounded-[var(--radius)] p-6 sm:p-8 border border-slate-200 shadow-sm space-y-4">
        <div className="flex items-center gap-2.5 pb-3 border-b border-slate-100">
          <div className="w-9 h-9 rounded-[var(--radius)] bg-emerald-50 text-emerald-800 flex items-center justify-center font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-medium text-slate-700 mb-1.5">Executive Scientific Bio</label>
            <textarea
              rows={3}
              value={form.bio}
              onChange={(e) => setForm({ ...form, bio: e.target.value })}
              className="w-full p-3 bg-slate-50 rounded-[var(--radius)] border border-slate-200 text-xs focus:bg-white focus:ring-2 focus:ring-blue-600 focus:outline-none font-medium leading-relaxed"
            />
          </div>

          <div>
            <label className="block text-xs font-medium text-slate-700 mb-1.5">Research Domains & Interests</label>
            <textarea
              rows={3}
      ...
      <div className="bg-white rounded-[var(--radius)] p-6 sm:p-8 border border-slate-200 shadow-sm space-y-5">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-[var(--radius)] bg-amber-50 text-amber-800 flex items-center justify-center font-medium">
        ...
        {form.certificates.length === 0 ? (
          <div className="py-10 text-center space-y-3">
            <div className="w-12 h-12 bg-amber-50 text-amber-400 rounded-[var(--radius)] flex items-center justify-center mx-auto">
              <Award className="w-6 h-6" />
            </div>
            <h4 className="font-medium text-slate-700 text-sm">No Certificates Yet</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {form.certificates.map((cert, cIdx) => {
              ...
              return (
                <div key={cIdx} className="p-4 bg-slate-50/90 rounded-[var(--radius)] border border-slate-200/80 space-y-2 flex flex-col justify-between">
                  <div>
                    ...
                    {cert.grade && (
                      <p className="text-[11px] font-medium text-slate-600 mt-0.5">{cert.grade}</p>
                    )}
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-200/60 flex items-center justify-between gap-2">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="text-[11px] font-medium text-blue-700 hover:text-blue-900 flex items-center gap-1 hover:underline"
                      >
                      ...
                      {cert.verificationUrl && (
                        <a
                          ...
                          className="text-[11px] font-medium text-emerald-700 hover:text-emerald-900 flex items-center gap-1 hover:underline"
                        >
        ...
        {/* Add Certificate Row */}
        <div className="p-4 bg-blue-50/50 rounded-[var(--radius)] border border-blue-100 flex flex-col md:flex-row items-center gap-3">
          <input
            type="text"
            placeholder="Certificate Title..."
            value={newCert.title}
            onChange={(e) => setNewCert({ ...newCert, title: e.target.value })}
            className="flex-1 w-full p-2.5 bg-white rounded-[var(--radius)] border border-slate-200 text-xs focus:ring-2 focus:ring-blue-600 focus:outline-none"
          />
          <input
            type="text"
            ...
            className="w-full md:w-64 p-2.5 bg-white rounded-[var(--radius)] border border-slate-200 text-xs focus:ring-2 focus:ring-blue-600 focus:outline-none"
          />
          <input
            type="text"
            placeholder="Year"
            ...
            className="w-full md:w-24 p-2.5 bg-white rounded-[var(--radius)] border border-slate-200 text-xs focus:ring-2 focus:ring-blue-600 focus:outline-none"
          />
          <button
            type="button"
            onClick={handleAddCertificate}
            className="w-full md:w-auto px-4 py-2.5 bg-[#0a2558] hover:bg-[#071c42] text-white font-semibold rounded-[var(--radius)] text-xs shrink-0 flex items-center justify-center gap-1 shadow-sm"
          >
            <Plus className="w-4 h-4" />
            <span>Add</span>
          </button>
      ...
      {/* ═════════ BOTTOM ACTION BAR ═════════ */}
      <div className="bg-white rounded-[var(--radius)] p-6 border border-slate-200 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button
            onClick={() => handleSaveProfile(false)}
            disabled={loading}
            className="flex-1 sm:flex-none px-5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-extrabold rounded-[var(--radius)] text-xs transition-colors"
          >
            Save Draft
          </button>
          ...
          <button
            onClick={() => handleSaveProfile(true)}
            disabled={loading}
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-2.5 bg-[#0a2558] hover:bg-[#071c42] text-white font-extrabold rounded-[var(--radius)] text-xs shadow-lg transition-transform hover:scale-105"
          >
