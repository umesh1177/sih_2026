      ...
      <div className="bg-white rounded-3xl max-w-3xl w-full p-6 shadow-2xl border border-slate-200 my-8">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={handlePrint}
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[#0a2558] hover:bg-[#071c42] text-white rounded-lg text-xs font-bold transition-all shadow-sm"
            >
        ...
        <div id="certificate-print-area" className="p-8 bg-gradient-to-br from-amber-50/40 via-white to-blue-50/40 rounded-2xl border-4 border-double border-amber-500/50 shadow-inner relative text-center overflow-hidden">
          ...
          {/* Certificate Title */}
          <h1 className="text-xl md:text-2xl font-serif italic text-slate-900 font-bold mb-2">
          ...
          <div className="py-2 mb-3">
            <h2 className="text-2xl font-bold text-[#0a2558] tracking-wide underline decoration-amber-400 decoration-2 underline-offset-8">
              {name}
            </h2>
