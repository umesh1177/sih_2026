    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 flex flex-col font-sans select-none antialiased">
      ...
      <header className="bg-white border-b border-slate-200 shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3.5 shrink-0 overflow-hidden">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-blue-600 text-white flex items-center justify-center font-black text-xl sm:text-2xl shadow-md border-2 border-blue-200 shrink-0">
              Q
            </div>
            <div className="overflow-hidden">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <span className="text-sm sm:text-base lg:text-lg font-black text-slate-900 tracking-tight truncate">
                  CAPACITY CONNECT
                </span>
                <span className="hidden xs:inline-block px-1.5 sm:px-2 py-0.5 rounded-full text-[8px] sm:text-[9px] font-extrabold bg-blue-100 text-blue-900 uppercase border border-blue-200 shrink-0">
                  MoES • IMD
                </span>
              </div>
              <p className="text-[10px] sm:text-[11px] lg:text-xs text-slate-500 font-medium hidden sm:block truncate">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-4 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border sm:border-2 border-emerald-400 rounded-xl text-xs font-black shadow-sm transition-all hover:scale-105 active:scale-95 group shrink-0"
            ...
            >
              ...
              <span className="font-extrabold tracking-tight hidden xs:inline sm:inline">Verify Certificate</span>
              <span className="font-extrabold tracking-tight xs:hidden">Verify</span>
            </button>

            <button
              onClick={() => onOpenLoginPage && onOpenLoginPage()}
              className="px-3 sm:px-4 py-2 border border-slate-300 hover:bg-slate-100 text-slate-700 font-bold rounded-xl text-xs transition-colors shrink-0"
            >
              Sign In
            </button>
            ...
            <button
              onClick={() => onOpenLoginPage && onOpenLoginPage()}
              className="hidden lg:inline-flex items-center gap-1.5 px-4 sm:px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-xs shadow-md transition-all hover:scale-105 shrink-0"
            >
            ...
            <button
              ...
              className="md:hidden p-2 text-slate-600 hover:text-blue-600 hover:bg-slate-100 rounded-xl transition-colors shrink-0"
        ...
        {isMobileNavOpen && (
          <div className="md:hidden border-t border-slate-200 bg-white px-4 py-4 space-y-3 shadow-lg animate-in slide-in-from-top-2">
            <div className="space-y-1">
              <a 
                href="#curricula-section" 
                onClick={() => setIsMobileNavOpen(false)}
                className="flex items-center gap-2.5 px-3 py-2 text-xs font-bold text-slate-700 hover:bg-blue-50 rounded-xl"
              >
                <BookOpen className="w-4 h-4 text-blue-600" />
                <span>Curricula Catalog</span>
              </a>
              <a 
                ...
                onClick={() => setIsMobileNavOpen(false)}
                className="flex items-center gap-2.5 px-3 py-2 text-xs font-bold text-slate-700 hover:bg-emerald-50 rounded-xl"
              >
                <ShieldCheck className="w-4 h-4 text-emerald-600" />
                <span>Verification Ledger</span>
              </a>
              <a 
                ...
                onClick={() => setIsMobileNavOpen(false)}
                className="flex items-center gap-2.5 px-3 py-2 text-xs font-bold text-slate-700 hover:bg-amber-50 rounded-xl"
              >
                <Sparkles className="w-4 h-4 text-amber-500" />
                <span>Pillars</span>
              </a>
            ...
            {/* Mobile Fast Demo Switcher */}
            <div className="pt-3 border-t border-slate-100">
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">
                Fast Demo Account Roles:
              </p>
              <div className="grid grid-cols-3 gap-2">
                {demoAccounts.map((acc, i) => (
                  <button
                    ...
                    className="px-2 py-2 bg-slate-100 hover:bg-blue-600 hover:text-white rounded-xl text-[11px] font-bold text-slate-700 transition-colors text-center"
                  >
                    {acc.role.toUpperCase()}
                  </button>
                ))}
      ...
      {/* ─── 3. MODERN HERO SECTION (LIGHT THEME & CLEAN ELEVATION) ─── */}
      <section className="bg-gradient-to-b from-blue-50/70 via-slate-50/50 to-white text-slate-900 py-12 lg:py-18 px-4 sm:px-6 lg:px-8 relative overflow-hidden border-b border-slate-200">
        ...
        <div className="absolute -bottom-24 -left-24 w-96 h-96 rounded-full bg-emerald-200/20 blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight leading-tight text-slate-900">
              Empowering India's Meteorological Workforce Through <span className="text-blue-600">Digital Competency Mastery</span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-slate-200 max-w-lg">
              <div>
                ...
                <p className="text-[11px] text-slate-500 font-medium">Certified Officers</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-black text-slate-900">36</p>
                <p className="text-[11px] text-slate-500 font-medium">Regional Met Centres</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-black text-emerald-600">100%</p>
                <p className="text-[11px] text-slate-500 font-medium">Verifiable Credentials</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl p-6 sm:p-7 border border-slate-200 shadow-md space-y-4">
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-center gap-1.5 flex-wrap text-[10px] text-slate-500 pt-1">
                <span className="font-semibold text-slate-700">Sample Credential IDs:</span>
                <button
                  onClick={() => {
                    setVerifyQuery("MOES-CERT-NWP-401-0981");
                    handlePerformVerification("MOES-CERT-NWP-401-0981");
                  }}
                  className="underline hover:text-blue-700 font-mono cursor-pointer"
                >
                  ...
                  <div>
                    ...
                    <div className="h-44 overflow-hidden relative bg-slate-100">
                      ...
                      <div className="absolute top-3 left-3 right-3 flex items-center justify-between">
                        <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-blue-600 text-white shadow">
                          {course.code}
                        </span>
                        {isNewlyCreated && (
      ...
      <footer className="bg-slate-900 text-white py-10 border-t border-slate-800 px-4 sm:px-6 lg:px-8 text-center text-xs">
        <div className="max-w-7xl mx-auto space-y-4">
          ...
          <div className="pt-4 border-t border-slate-800 text-slate-500 text-[10px] flex items-center justify-between flex-wrap gap-2">
